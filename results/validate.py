...
def main():
    ...
    parser.add_argument('-b', '--base', required=True, help='Path to the base results file')
    parser.add_argument('-f', '--file', required=True, help='Path to the file to compare')
    args = parser.parse_args()

    results_file = args.base
